...
<div heading-div>
       ...
       <a href="home.jsp"><h4>X</h4></a>
        <table>
        	<tr><td><input type="hidden" id="taskname" name="id" value="<%=request.getParameter("id")%>"></td></tr>
            <tr><td><label for="taskname">Edit Task Name:</label></td></tr>
            <tr><td><input type="text" id="taskname" name="edittaskname" value="<%=request.getParameter("des")%>" required="required"></td></tr>
            
            
            <tr><td><label for="taskdes">Edit Task Description:</label></td></tr>
            <tr><td><input type="text" id="taskdes" name="edittaskdes" value="<%=request.getParameter("taskname")%>" required="required"></td></tr>
